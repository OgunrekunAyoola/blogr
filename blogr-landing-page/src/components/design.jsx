	...
	return (
		<div className="flex flex-col align-center justify-center mx-[7vw]">
			<div className="my-4 w-auto">
				<h2 className=" align-center justify-center mt-10 w-full text-center text-4xl">Designed for the future</h2>
			</div>
			...
			<div className="flex flex-col-reverse sm:flex-row py-10">
				...
				<div className="w-full sm:text-center ss:text-center xs:text-center">
					<picture className="design-img">
						<source
